	...
	<main class="container-fluid">
		...
		<figure>
			...
			function getReasonsDetails(facultyId) {
				let url ="getReasonAbsent/"+facultyId;
				axios.get(url).then(res=> {
					console.log(res.data);
					let details=res.data;
					let i=0;
					let content="";
					for( let absent of details) {
						content+="<tr>";
						content+="<td>"+absent.studentRollNumber+"</td>";
						content+="<td>"+absent.studentName+"</td>";
						content+="<td>"+absent.reasonDate+"</td>";
						content+="<td>"+absent.attendanceType+"</td>";
						content+="<td>"+absent.reason+"</td>";
						content+="<td>"+absent.parentMobileNumber+"</td>";
						content+="</tr>";
					}		
					document.querySelector("#absentTable").innerHTML=content;		
				});
			 }
